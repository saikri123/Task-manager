...
export const Navbar = () => {
  ...
  return (
    <header className='=sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans' >
        <div className='flex items-center px-4 py-3 md:px-6 mx-w-7xl max-auto'>
            <div className='flex items-center gap-2 curser-pointer group '
            onClick={()=> navigate('/')}>
            ...
            <div className='flex items-center gap-4 '>
                ...
                <div ref={menuref} className='relative'>
                    <button onClick={handleMenuToggle} className=' flex items-center gap-2 px-3 py-2 rounded-full curser-pointer hover:bg-orange-50  transition-colors duration-300  border border-traspernt '>
                    ...
                    {menuOpen &&(
                        <ul className='absolute top-14 right-0 w-56  bg-white rounded-2xl shadow-xl border -orange -100 z-50 overflow-hidden animate-fadeIn'>
                            ...
                            <li className='p-2 '>
                                <button onClick={handleLogout} className='flex w-full items-center gap-2 rounded-lg px-3  py-2 text-sm hover:bg-red-600'>
